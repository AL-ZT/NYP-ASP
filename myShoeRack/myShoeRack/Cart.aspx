<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Cart.aspx.cs" Inherits="myShoeRack.Cart" %>
        ...
        <div class="container">
            <div class="cart_inner">
                <div class="table-responsive">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnRowDeleting="GridView1_RowDeleting" Width="100%" CssClass="table" GridLines="None" RowStyle-Height="120px">
                        <Columns>
                            ...
                            <asp:CommandField DeleteText="Remove" HeaderText="Remove from Cart" ShowDeleteButton="True">
                    ...
                    <asp:LinkButton ID="LinkButton1" runat="server" CssClass="gray_btn" OnClick="btnCheckout">Checkout</asp:LinkButton>--%>
