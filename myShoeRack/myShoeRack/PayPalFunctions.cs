...
public class NVPAPICaller
{
    ...
    public string APIUsername = "myshoerack_api1.gmail.com";
    private string APIPassword = "YDTHGK6DRUUYWGTJ";
    private string APISignature = "AaNJ2qCchBz1TozY6kOlKFjy4fK2ADSPqiZgS80nOp3YH26X9ORblfC3";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://myshoerack.azurewebsites.net/CheckoutReview.aspx";
        string cancelURL = "https://myshoerack.azurewebsites.net/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "myShoeRack";
        encoder["PAYMENTREQUEST_0_AMT"] = amt;
        encoder["PAYMENTREQUEST_0_ITEMAMT"] = amt;
        encoder["PAYMENTREQUEST_0_PAYMENTACTION"] = "Sale";
        encoder["PAYMENTREQUEST_0_CURRENCYCODE"] = "SGD";
